...
function App() {
 const [widgets, setWidgets] = useState([
  ...
  { id: new Date().getTime() + 3, component: <CalendarWidget />, area: 'right-widget', name: "Calendar" },
  { id: new Date().getTime() + 2, component: <TimerWidget />, area: 'left-widget', name:"Timer" },
  { id: new Date().getTime() + 1, component: <MyCustomWidget />, area: 'left-widget', name:"MyCustom" },
 ])
